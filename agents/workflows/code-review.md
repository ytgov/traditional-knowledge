---
description: Code Review Quality Control Workflow for TypeScript code in the Traditional Knowledge project
---

# Code Review Quality Control Workflow

Use this workflow to review TypeScript code for the Traditional Knowledge project. Apply every rule below as a hard gate — flag any violation as a blocking issue. For each issue found, quote the offending lines and state which rule they violate.
