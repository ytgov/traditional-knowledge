...
### Common TK Context Patterns

**Knowledge Entry Issues:**
- Include specific entry types and categories
- Reference cultural protocol levels
- Include language metadata when relevant

**Information Sharing Agreement Issues:**
- Include agreement status and parties involved
- Reference group creation and access control
- Include signing workflow context

**Access Control Issues:**
- Include user roles and permissions
- Reference group membership
- Include cultural protocol restrictions
...
_Update this workflow when you discover better patterns or Traditional Knowledge project conventions evolve._
