...
export class NotifyUserOfRemovalMailer extends ApplicationMailer {
  constructor(
    private group: Group,
    private user: User
  ) {
  ...
  async perform() {
    ...
    const subject = `${APPLICATION_NAME}: You have been removed from a group`
...
export default NotifyUserOfRemovalMailer
