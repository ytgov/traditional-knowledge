...
export async function up(knex: Knex): Promise<void> {
  await knex.raw(/* sql */ `
    CREATE OR ALTER VIEW archive_item_information_sharing_agreement_access_grants AS
    SELECT
      information_sharing_agreement_archive_items.archive_item_id,
      information_sharing_agreement_archive_items.information_sharing_agreement_id,
      information_sharing_agreement_access_grants.id AS access_grant_id,
      information_sharing_agreement_access_grants.group_id,
      information_sharing_agreement_access_grants.user_id,
